...
<!-- Do not change any of the comments, they are there for explanatory usage. Pictures, titles and paragraphs can be changes from this file and this file alone. Please do not touch the raw html files unless you're aware of what you're doing. -->

<!-- All paragraphs (everything that has "content" in front) needs to be kept inside the apostrofs (``). Please do not remove these when editing the content. When a break inbetween paragraphs is needed, then please use "<br><br>". -->

{{<header>}}

<!-- Section : hero Landing page + Slider -->
...
{{< hero
  subtitle="The knights of the kitchen table"  
   ...
   video-url="images/Mono_Roleplay.mp4"
...
<!-- Section : Article-quote Introduction to the knights -->
...
<!-- Section : Article-picture Association activities -->
...
<!-- Section : Article-picture-green Tabletop Roleplay -->
...
{{< article-picture-green 
  ...
  image-url="images/tabletoproleplay-section.jpeg"

>}}

<!-- Section : Article-quote-right Tabletop roleplay Roll dice create stories -->
...
<!-- Section : Article-picture-left Boardgames -->
...
{{< article-picture-left
  ...
  image-url="images/boardgames-section.jpeg"

>}}

<!-- Section : Article-picture-green-right LARP -->
...
<!-- Section : Article-picture-left Events -->
...
<!-- Section : Article-quote-left-green Fantasy Court -->
...
<!-- Section : Article-picture Knights weekend -->
...
<!-- Section : Call-to-action__wanna-join Want to join? -->
